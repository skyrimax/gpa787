...
int main(int args, char *argv[])
{
    ...
    FILE* csv_file = NULL;
    csv_file = fopen("resultats_simulation_PID_MIMO_cfg1.csv", "w");
    ...
    init_param_MIMO_PID(&params_MIMO_PID, 0.0, 5.0, 2.0, 0.1, 0, 1.0/1.0, 0.0, 5.0, 2.0/6.0, 0.1/6.0, 0.0, 1.0/1.0);

    // Initialisation de la structure de la simulation
    if(init_param_simulation(&struct_simulation, 1.0, 500, MIMO_PID_config1, &params_MIMO_PID)) {
